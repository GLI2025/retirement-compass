    ...
    <section id="currentAge" className="glass-card p-4 sm:p-6 space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <StepInput
          ...
          helperText="Enter your total monthly spending in today’s dollars, including housing. Include housing in your total monthly expenses. Housing Details separates the housing portion so the calculator can model its growth and payoff correctly; it is not added a second time."
          min={0}
          max={50000}
          step={100}
          prefix="$"
          tooltip="Total monthly lifestyle spending in today’s dollars, housing included. Housing Details only changes how the housing portion grows or ends."
        />
      </div>
